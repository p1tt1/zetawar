(set-env!
 ...
 '[;; Dev
   ...
   [boot-codox "0.10.8" :scope "test"]
   [com.cemerick/piggieback "0.2.1" :scope "test"]
   [crisptrutski/boot-cljs-test "0.3.0" :scope "test"]
   [deraen/boot-sass "0.6.0" :scope "test"]
   ...
   [perun "0.5.0-SNAPSHOT" :scope "test"]
...
(require
 ...
 '[adzerk.boot-cljs-repl :refer [cljs-repl-env]]
 ...
 '[io.perun :refer [global-metadata markdown permalink render slug collection]]
