...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__51597,storage_key){
var map__51598 = p__51597;
var map__51598__$1 = cljs.core.__destructure_map(map__51598);
var posh_tree = map__51598__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51598__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51598__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__51600 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51600,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51600,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51600,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51600,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__51603,storage_key){
var map__51604 = p__51603;
var map__51604__$1 = cljs.core.__destructure_map(map__51604);
var posh_tree = map__51604__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51604__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51604__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__51606 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51606,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51606,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51606,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51606,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__51611,storage_key){
var map__51613 = p__51611;
var map__51613__$1 = cljs.core.__destructure_map(map__51613);
var posh_tree = map__51613__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51613__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51613__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__51615 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51615,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51615,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51615,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__51620){
var vec__51621 = p__51620;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51621,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51621,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__51639){
var vec__51643 = p__51639;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51643,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51643,(1),null);
...
var G__51683 = cljs.core.first(storage_key);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51683__$1)].join('')));
