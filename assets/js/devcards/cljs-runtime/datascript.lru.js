...
var G__43793 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__43793) : datascript.lru.cleanup_lru.call(null,G__43793));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__43794 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43794,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43794,(1),null);
...
var datascript$lru$ICache$_get$dyn_43804 = (function (this$,key,compute_fn){
...
return datascript$lru$ICache$_get$dyn_43804(this$,key,compute_fn);
}
});
...
*/
datascript.lru.t_datascript$lru43799 = (function (limit,_STAR_impl,meta43800){
this.limit = limit;
...
(datascript.lru.t_datascript$lru43799.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43801,meta43800__$1){
var self__ = this;
var _43801__$1 = this;
return (new datascript.lru.t_datascript$lru43799(self__.limit,self__._STAR_impl,meta43800__$1));
}));

(datascript.lru.t_datascript$lru43799.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43801){
var self__ = this;
var _43801__$1 = this;
return self__.meta43800;
}));

(datascript.lru.t_datascript$lru43799.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru43799.prototype.datascript$lru$ICache$_get$arity$3 = (function (_,key,compute_fn){
var self__ = this;
var ___$1 = this;
...
(datascript.lru.t_datascript$lru43799.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta43800","meta43800",774626939,null)], null);
}));

(datascript.lru.t_datascript$lru43799.cljs$lang$type = true);

(datascript.lru.t_datascript$lru43799.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru43799");

(datascript.lru.t_datascript$lru43799.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"datascript.lru/t_datascript$lru43799");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru43799.
 */
datascript.lru.__GT_t_datascript$lru43799 = (function datascript$lru$__GT_t_datascript$lru43799(limit,_STAR_impl,meta43800){
return (new datascript.lru.t_datascript$lru43799(limit,_STAR_impl,meta43800));
});


datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
return (new datascript.lru.t_datascript$lru43799(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
