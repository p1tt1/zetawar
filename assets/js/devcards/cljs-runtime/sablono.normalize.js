...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__39058){
var vec__39059 = p__39058;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39059,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39059,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__39064_SHARP_){
return (((p1__39064_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__39064_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__39065,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__39065;
}
});
...
var len__5769__auto___39126 = arguments.length;
var i__5770__auto___39127 = (0);
while(true){
if((i__5770__auto___39127 < len__5769__auto___39126)){
args__5775__auto__.push((arguments[i__5770__auto___39127]));

var G__39128 = (i__5770__auto___39127 + (1));
i__5770__auto___39127 = G__39128;
continue;
} else {
}
break;
...
var G__39067 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39067,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__39067;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq39066){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq39066));
}));
...
var vec__39070 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__39074 = cljs.core.ffirst(matches);
var fexpr__39073 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__39073.cljs$core$IFn$_invoke$arity$1 ? fexpr__39073.cljs$core$IFn$_invoke$arity$1(G__39074) : fexpr__39073.call(null,G__39074));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39070,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39070,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__39068_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__39068_SHARP_))){
return p1__39068_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__39069_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__39069_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__39107){
var vec__39108 = p__39107;
var seq__39109 = cljs.core.seq(vec__39108);
var first__39110 = cljs.core.first(seq__39109);
var seq__39109__$1 = cljs.core.next(seq__39109);
var tag = first__39110;
var content = seq__39109__$1;
...
var vec__39117 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39117,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39117,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39117,(2),null);
