...
var clojure$test$check$random$IRandom$rand_long$dyn_52358 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_52358(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_52359 = (function (rng){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_52359(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_52360 = (function (rng){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_52360(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_52361 = (function (rng,n){
var x__5393__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_52361(rng,n);
}
});
...
var G__52267 = z;
if(((24) > (function (){var G__52271 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__52271) : clojure.test.check.random.longs.bit_count.call(null,G__52271));
})())){
return clojure.test.check.random.longs.bit_xor(G__52267,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__52267;
}
});
...
var G__52381 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__52382 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__52381;
ret = G__52382;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__52326){
var map__52336 = p__52326;
var map__52336__$1 = cljs.core.__destructure_map(map__52336);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52336__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__52340 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52340,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52340,(1),null);
