...
var i_34338 = (0);
while(true){
if((i_34338 < arr.length)){
(arr[i_34338] = null);

var G__34339 = (i_34338 + (1));
i_34338 = G__34339;
continue;
} else {
}
...
var i_34348 = (self__.level + (1));
while(true){
if((i_34348 <= (new_level + (1)))){
(update[i_34348] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_34350 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34350[i]));
} else {
x__$2.forward.push((((i < links_34350.length))?(links_34350[i]):null));
}

if((i < links_34350.length)){
(links_34350[i] = x__$2);
} else {
links_34350.push(x__$2);
}
...
var i_34352 = (0);
while(true){
if((i_34352 <= self__.level)){
var links_34353 = (update[i_34352]).forward;
if((x__$1 === (((i_34352 < links_34353.length))?(links_34353[i_34352]):null))){
(links_34353[i_34352] = (x__$1.forward[i_34352]));

var G__34354 = (i_34352 + (1));
i_34352 = G__34354;
continue;
} else {
var G__34355 = (i_34352 + (1));
i_34352 = G__34355;
continue;
}
} else {
...
var G__34357 = nx;
var G__34358 = (level__$1 - (1));
x = G__34357;
level__$1 = G__34358;
continue;
} else {
var G__34359 = x;
var G__34360 = (level__$1 - (1));
x = G__34359;
level__$1 = G__34360;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__34362 = nx;
var G__34363 = (level__$1 - (1));
x = G__34362;
level__$1 = G__34363;
continue;
} else {
var G__34364 = x;
var G__34365 = (level__$1 - (1));
x = G__34364;
level__$1 = G__34365;
continue;
}
...
var or__5045__auto__ = (cljs.core.truth_((function (){var and__5043__auto__ = me__$1;
