...
var len__5769__auto___30044 = arguments.length;
var i__5770__auto___30045 = (0);
while(true){
if((i__5770__auto___30045 < len__5769__auto___30044)){
args__5775__auto__.push((arguments[i__5770__auto___30045]));

var G__30046 = (i__5770__auto___30045 + (1));
i__5770__auto___30045 = G__30046;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq29939){
var G__29940 = cljs.core.first(seq29939);
var seq29939__$1 = cljs.core.next(seq29939);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29940,seq29939__$1);
}));
...
return cljs.core.some((function (p1__29943_SHARP_){
return (p1__29943_SHARP_ === object);
}),history__$1);
});
...
(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__29950){
var vec__29951 = p__29950;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29951,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq29946){
var G__29947 = cljs.core.first(seq29946);
var seq29946__$1 = cljs.core.next(seq29946);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29947,seq29946__$1);
}));

devtools.formatters.state.seek_path_segment = (function devtools$formatters$state$seek_path_segment(var_args){
var args__5775__auto__ = [];
var len__5769__auto___30060 = arguments.length;
var i__5770__auto___30061 = (0);
while(true){
if((i__5770__auto___30061 < len__5769__auto___30060)){
args__5775__auto__.push((arguments[i__5770__auto___30061]));

var G__30062 = (i__5770__auto___30061 + (1));
i__5770__auto___30061 = G__30062;
continue;
} else {
}
break;
...
(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__29965){
var vec__29966 = p__29965;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29966,(0),null);
...
var _STAR_ = (function (p__29973){
var vec__29974 = p__29973;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29974,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29974,(1),null);
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq29960){
...
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29961,G__29962,seq29960__$2);
}));
