...
var sablono$util$ToString$to_str$dyn_39031 = (function (x){
...
return sablono$util$ToString$to_str$dyn_39031(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_39036 = (function (x){
var x__5393__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_39036(x);
}
});
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq39002){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq39002));
}));
...
var vec__39004 = cljs.core.name(k).split("-");
...
var first_word = first__39006;
var words = seq__39005__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__39008){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__39013,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__39013;
}
} else {
