...
var map__30014 = top_item;
var map__30014__$1 = cljs.core.__destructure_map(map__30014);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30014__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30014__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30014__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e30010){var _e = e30010;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___30096 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5821__auto___30096)){
var seen_errors_30097 = temp__5821__auto___30096;
if(cljs.core.truth_(seen_errors_30097.has(self))){
} else {
seen_errors_30097.add(self);

var temp__5823__auto___30098 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5823__auto___30098)){
var sense_30101 = temp__5823__auto___30098;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30101)].join(''));
} else {
}
}
} else {
