...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30311){
var G__30312 = cljs.core.first(seq30311);
var seq30311__$1 = cljs.core.next(seq30311);
var G__30313 = cljs.core.first(seq30311__$1);
var seq30311__$2 = cljs.core.next(seq30311__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30312,G__30313,seq30311__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30321_SHARP_){
return (!((cljs.core.meta(p1__30321_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30339__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30342){var _e__29212__auto__ = e30342;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e30346){var _e__29212__auto__ = e30346;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30355 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30356 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30356);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30357__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30355);
}});
...
var temp__5821__auto___30409 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5821__auto___30409)){
var managed_print_level_30411 = temp__5821__auto___30409;
var _STAR_print_level_STAR__orig_val__30360_30412 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30361_30413 = managed_print_level_30411;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30361_30413);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30358_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30358_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30360_30412);
}} else {
job_fn();
}
