...
var G__43881 = o;
reagent.impl.template.goog$module$goog$object.set(G__43881,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__43901__delegate = function (args){
...
while (G__43902__i < G__43902__a.length) {G__43902__a[G__43902__i] = arguments[G__43902__i + 0]; ++G__43902__i;}
  args = new cljs.core.IndexedSeq(G__43902__a,0,null);
} 
return G__43901__delegate.call(this,args);};
G__43901.cljs$lang$maxFixedArity = 0;
G__43901.cljs$lang$applyTo = (function (arglist__43903){
var args = cljs.core.seq(arglist__43903);
return G__43901__delegate(args);
});
...
var G__43882 = o;
reagent.impl.template.goog$module$goog$object.set(G__43882,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__43904__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__43904 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__43905__i < G__43905__a.length) {G__43905__a[G__43905__i] = arguments[G__43905__i + 0]; ++G__43905__i;}
  args = new cljs.core.IndexedSeq(G__43905__a,0,null);
} 
return G__43904__delegate.call(this,args);};
G__43904.cljs$lang$maxFixedArity = 0;
G__43904.cljs$lang$applyTo = (function (arglist__43906){
var args = cljs.core.seq(arglist__43906);
return G__43904__delegate(args);
});
...
var G__43883 = props;
var G__43883__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43883,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__43883);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43883__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__43884 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__43884,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__43884;
}
})(),id_class);
...
var G__43885 = (cljs.core.count(argv) - first_child);
switch (G__43885) {
case (0):
...
var vec__43887 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43887,(2),null);
...
var temp__5827__auto___43910 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___43910 == null)){
} else {
var key_43911 = temp__5827__auto___43910;
(jsprops.key = key_43911);
}
...
var temp__5827__auto___43912 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___43912 == null)){
} else {
var key_43913 = temp__5827__auto___43912;
(jsprops.key = key_43913);
}
...
var temp__5827__auto___43914 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___43914 == null)){
} else {
var key_43915 = temp__5827__auto___43914;
(jsprops.key = key_43915);
}
...
var temp__5827__auto___43916 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___43916 == null)){
} else {
var key_43917 = temp__5827__auto___43916;
(jsprops.key = key_43917);
}
...
var temp__5827__auto___43918 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___43918 == null)){
} else {
var key_43919 = temp__5827__auto___43918;
(jsprops.key = key_43919);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43890_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__43890_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__43892 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43892,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43892,(1),null);
...
break;
default:
var G__43921 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__43922 = compiler;
v = G__43921;
compiler = G__43922;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template43898 = (function (opts,id,fn_to_element,parse_fn,meta43899){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template43898.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_43900,meta43899__$1){
var self__ = this;
var _43900__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template43898(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta43899__$1));
}));

(reagent.impl.template.t_reagent$impl$template43898.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_43900){
var self__ = this;
var _43900__$1 = this;
return self__.meta43899;
}));

(reagent.impl.template.t_reagent$impl$template43898.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template43898.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template43898.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template43898.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template43898.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template43898.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta43899","meta43899",334566355,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template43898.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template43898.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template43898");

(reagent.impl.template.t_reagent$impl$template43898.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template43898");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template43898.
 */
reagent.impl.template.__GT_t_reagent$impl$template43898 = (function reagent$impl$template$__GT_t_reagent$impl$template43898(opts,id,fn_to_element,parse_fn,meta43899){
return (new reagent.impl.template.t_reagent$impl$template43898(opts,id,fn_to_element,parse_fn,meta43899));
});
...
return (new reagent.impl.template.t_reagent$impl$template43898(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
