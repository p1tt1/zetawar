...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_41856 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_41856(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_41857 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_41857(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41858 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_41858(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41859 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_41859(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41861 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_41861(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41862 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_41862(reader);
}
});
...
var G__41892 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__41893 = s.append(c);
c = G__41892;
s = G__41893;
continue;
}
