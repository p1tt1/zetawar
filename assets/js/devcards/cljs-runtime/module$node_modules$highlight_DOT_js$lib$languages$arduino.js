shadow$provide.module$node_modules$highlight_DOT_js$lib$languages$arduino=function(global,require,module,exports){module.exports=function(hljs){var regex=hljs.regex,C_LINE_COMMENT_MODE=hljs.COMMENT("//","$",{contains:[{begin:/\\\n/}]});const FUNCTION_TYPE_RE="(?!struct)(decltype\\(auto\\)|"+regex.optional("[a-zA-Z_]\\w*::")+"[a-zA-Z_]\\w*"+regex.optional("\x3c[^\x3c\x3e]+\x3e")+")",CPP_PRIMITIVE_TYPES={className:"type",begin:"\\b[a-z\\d_]*_t\\b"},STRINGS={className:"string",variants:[{begin:'(u8?|U|L)?"',
...
{begin:"[+-]?\\b(?:0[Bb][01](?:'?[01])*|0[Xx][0-9A-Fa-f](?:'?[0-9A-Fa-f])*|0(?:'?[0-7])*|[1-9](?:'?[0-9])*)(?:[Uu](?:LL?|ll?)|[Uu][Zz]?|(?:LL?|ll?)[Uu]?|[Zz][Uu]|)"}],relevance:0},PREPROCESSOR={className:"meta",begin:/#\s*[a-z]+\b/,end:/$/,keywords:{keyword:"if else elif endif define undef warning error line pragma _Pragma ifdef ifndef include"},contains:[{begin:/\\\n/,relevance:0},hljs.inherit(STRINGS,{className:"string"}),{className:"string",begin:/<.*?>/},C_LINE_COMMENT_MODE,hljs.C_BLOCK_COMMENT_MODE]},
TITLE_MODE={className:"title",begin:regex.optional("[a-zA-Z_]\\w*::")+hljs.IDENT_RE,relevance:0},FUNCTION_TITLE=regex.optional("[a-zA-Z_]\\w*::")+hljs.IDENT_RE+"\\s*\\(",CPP_KEYWORDS={type:"bool char char16_t char32_t char8_t double float int long short void wchar_t unsigned signed const static".split(" "),keyword:"alignas alignof and and_eq asm atomic_cancel atomic_commit atomic_noexcept auto bitand bitor break case catch class co_await co_return co_yield compl concept const_cast|10 consteval constexpr constinit continue decltype default delete do dynamic_cast|10 else enum explicit export extern false final for friend goto if import inline module mutable namespace new noexcept not not_eq nullptr operator or or_eq override private protected public reflexpr register reinterpret_cast|10 requires return sizeof static_assert static_cast|10 struct switch synchronized template this thread_local throw transaction_safe transaction_safe_dynamic true try typedef typeid typename union using virtual volatile while xor xor_eq".split(" "),
