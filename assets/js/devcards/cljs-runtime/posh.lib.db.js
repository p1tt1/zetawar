...
var G__50922 = cljs.core.first(poshdb);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50922__$1)].join('')));
...
var G__50986 = cljs.core.cons(pdb,path);
var G__50987 = posh.lib.db.get_parent_db(pdb);
path = G__50986;
pdb = G__50987;
continue;
} else {
...
var G__50988 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__50988;
continue;
}
break;
...
var map__50937 = filters;
var map__50937__$1 = cljs.core.__destructure_map(map__50937);
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50937__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50937__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50937__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50937__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__5045__auto__ = db;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var fexpr__50938 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__50938.cljs$core$IFn$_invoke$arity$1 ? fexpr__50938.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__50938.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__50939 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__50939.cljs$core$IFn$_invoke$arity$2 ? fexpr__50939.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__50939.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__50940 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__50940.cljs$core$IFn$_invoke$arity$2 ? fexpr__50940.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__50940.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__50941 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__50941.cljs$core$IFn$_invoke$arity$2 ? fexpr__50941.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__50941.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__50947 = db__$4;
var G__50948 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__50946 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__50953,poshdb){
var map__50954 = p__50953;
var map__50954__$1 = cljs.core.__destructure_map(map__50954);
var posh_tree = map__50954__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50954__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50954__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__50959 = (function (){var G__50966 = posh_tree;
var G__50967 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__50966,G__50967) : posh.lib.db.poshdb__GT_db.call(null,G__50966,G__50967));
})();
var G__50960 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__50958 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
