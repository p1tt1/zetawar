...
return cljs.core.cons(cljs.core.first(s),(function (){var G__52253 = (n - (1));
var G__52254 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__52253,G__52254) : clojure.test.check.rose_tree.exclude_nth.call(null,G__52253,G__52254));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__52256 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__52256) : f.call(null,G__52256));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52255_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__52255_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__52255_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52257_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__52257_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__52257_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__52258_SHARP_){
var G__52260 = clojure.test.check.rose_tree.root(p1__52258_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__52260) : pred.call(null,G__52260));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5523__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__52261(s__52262){
return (new cljs.core.LazySeq(null,(function (){
var s__52262__$1 = s__52262;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__52262__$1);
if(temp__5823__auto__){
var xs__6383__auto__ = temp__5823__auto__;
var vec__52268 = cljs.core.first(xs__6383__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52268,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52268,(1),null);
var iterys__5519__auto__ = ((function (s__52262__$1,vec__52268,rose,index,xs__6383__auto__,temp__5823__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__52261_$_iter__52263(s__52264){
return (new cljs.core.LazySeq(null,((function (s__52262__$1,vec__52268,rose,index,xs__6383__auto__,temp__5823__auto__){
return (function (){
var s__52264__$1 = s__52264;
while(true){
var temp__5823__auto____$1 = cljs.core.seq(s__52264__$1);
if(temp__5823__auto____$1){
var s__52264__$2 = temp__5823__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__52264__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__52264__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__52266 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__52265 = (0);
while(true){
if((i__52265 < size__5522__auto__)){
var child = cljs.core._nth(c__5521__auto__,i__52265);
cljs.core.chunk_append(b__52266,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__52346 = (i__52265 + (1));
i__52265 = G__52346;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52266),clojure$test$check$rose_tree$permutations_$_iter__52261_$_iter__52263(cljs.core.chunk_rest(s__52264__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52266),null);
}
} else {
var child = cljs.core.first(s__52264__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__52261_$_iter__52263(cljs.core.rest(s__52264__$2)));
}
} else {
return null;
}
...
});})(s__52262__$1,vec__52268,rose,index,xs__6383__auto__,temp__5823__auto__))
,null,null));
});})(s__52262__$1,vec__52268,rose,index,xs__6383__auto__,temp__5823__auto__))
;
var fs__5520__auto__ = cljs.core.seq(iterys__5519__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5520__auto__,clojure$test$check$rose_tree$permutations_$_iter__52261(cljs.core.rest(s__52262__$1)));
} else {
var G__52347 = cljs.core.rest(s__52262__$1);
s__52262__$1 = G__52347;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52273_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__52273_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__52273_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52293_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__52293_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__52293_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__52304 = f;
var G__52308 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__52304,G__52308) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__52304,G__52308));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__52310 = f;
var G__52311 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__52310,G__52311) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__52310,G__52311));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
